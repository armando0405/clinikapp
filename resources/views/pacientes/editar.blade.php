...
@section('content')
    ...
    <div class="right_col" role="main">
        <div class="x_panel" >
            <div class="x_title">
                <h2 class="text-2xl font-bold text-center ">editar usuario</h2>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-10 col-8 my-3" >
                    <form action="{{ route('pacientes.update', $data->id ) }}" method="POST" class="form-label-left input_mask" >
                        @csrf
                        @method('PUT') 
                        ...
                        <div class="row" >
                            ...
                            {{-- Especialidad --}}
                            <div class="col-md-6 col-6 form-group has-feedback" >
                                <label class="col-form-label col-md-3 col-sm-3 label-align" style="font-weight: bold; color: #000; font-size: 16px;" for="first-name">Direccion
                                </label>
                                <div class="col-md-8 col-sm-8 ">
                                    <input type="text" id="especialidad" name="especialidad" value="{{ $data->direccion }}" required="required" class="form-control ">
                                </div>
                            </div>
                        </div>
