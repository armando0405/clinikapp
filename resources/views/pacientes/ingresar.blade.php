        ...
        <div class="x_panel" >
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-10 col-8 my-3" >
                    ...
                    <form class="form-label-left input_mask" action="{{ route('pacientes.store') }}" method="POST">
                        @csrf
                        @method('POST')
                        <div class="row">
                            {{-- NOMBRE --}}
                        ...
                        <div class="row">
                            {{-- foto --}}
                            <div class="col-md-6 col-12 form-group has-feedback">
                                <input type="text" class="form-control has-feedback-left" id="foto" name="foto" value="https://randomuser.me/api/portraits/men/17.jpg" placeholder="Foto">
